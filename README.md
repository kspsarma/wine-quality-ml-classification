...
o	Red Wine (Vinho Verde): 1,599 samples
o	White Wine (Vinho Verde): 4,898 samples
•	Number of Features: 12 physicochemical properties + 1 derived feature
•	Classification Type: Binary Classification
•	Target Variable: 
o	Class 0: Average Wine (original quality < 6)
o	Class 1: Good Wine (original quality ≥ 6)
•	Class Distribution: 
o	Good Wine: 3,258 samples (50.2%)
o	Average Wine: 3,239 samples (49.8%)
